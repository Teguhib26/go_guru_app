...
class VerifikasiTungguPage extends StatefulWidget {
  final String guruName;
  final String instrument;

  const VerifikasiTungguPage({
    super.key,
  ...
  @override
  State<VerifikasiTungguPage> createState() => _VerifikasiTungguPageState();
}

class _VerifikasiTungguPageState extends State<VerifikasiTungguPage>
